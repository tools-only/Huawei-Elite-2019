...
class Graph:
    def __init__(self, roads):
        ...
        for _, road in roads.iterrows():
            ...
            # print(id(self.cong_slice[road['id']])) # cong_slice
        ...
        for i in range(1, 2000):
            # print(id(self.cong_slice))
            cong_slice = copy.deepcopy(self.cong_slice)
            self.cong[i].append(cong_slice)
            # print(id(self.cong[i]))
            # print(id(self.cong))
